...
TilePanel::TilePanel(sf::RenderWindow *window_, const int16_t rows_, const int16_t columns_, const int16_t x_,
...
int TilePanel::manageKey(const sf::Keyboard::Scancode k) {
