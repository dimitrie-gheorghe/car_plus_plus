...
void VertexArrayUtility::translateX(sf::VertexArray &v, const float step) {
...
void VertexArrayUtility::translateY(sf::VertexArray &v, const float step) {
    const size_t len = v.getVertexCount();
    for (size_t i = 0; i < len; i++) {
        v[i].position.y += step;
    }
...
void VertexArrayUtility::setAscii(const int index, const int value) {
    ascii[index] = value;
}

// uint8_t VertexArrayUtility::ascii[8 * 95] = {
//     0b00011000,
//     0b00011000,
//     0b00011000,
//     0b00011000,
